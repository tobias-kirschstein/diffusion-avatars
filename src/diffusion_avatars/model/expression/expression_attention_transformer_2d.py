...
class ExpressionAttentionTransformer2DModel(ModelMixin, ConfigMixin):
    """
    ...
    def __init__(
            ...
            use_expression_attention: bool = False,
    ):
        super().__init__()
        self.use_linear_projection = use_linear_projection
        self.num_attention_heads = num_attention_heads
        self.attention_head_dim = attention_head_dim
        self.use_expression_attention = use_expression_attention
        ...
        self.transformer_blocks = nn.ModuleList(
            [
                ExpressionAttentionTransformerBlock(
                    inner_dim,
                    num_attention_heads,
                    attention_head_dim,
                    dropout=dropout,
                ...
                ) if use_expression_attention else
    ...
    def forward(
        ...
        for block in self.transformer_blocks:
            if self.training and self.gradient_checkpointing:
                ...
                if self.use_expression_attention:
                    hidden_states = block(
                        hidden_states,
