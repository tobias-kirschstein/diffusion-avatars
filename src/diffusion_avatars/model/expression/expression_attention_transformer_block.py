...
class ExpressionAttentionTransformerBlock(nn.Module):
    r"""
    ...
    def __init__(
        ...
        self._expression_attention.to_q.weight.init = torch.zeros_like(self.attn2.to_q.weight,
                                                                       device='cpu')  # self.to_q.weight
        self._expression_attention.to_k.weight.init = torch.zeros_like(self.attn2.to_k.weight,
                                                                       device='cpu')  # self.to_k.weight
        self._expression_attention.to_v.weight.init = torch.zeros_like(self.attn2.to_v.weight,
                                                                       device='cpu')  # self.to_v.weight
    ...
    def initialize_expression_attention(self):
        if not self._expression_attention_initialized:
            # Initialize with pretrained attention weights
            self._expression_attention.to_q.weight.data = self.attn2.to_q.weight.data.clone()
            self._expression_attention.to_k.weight.data = self.attn2.to_k.weight.data.clone()
            self._expression_attention.to_v.weight.data = self.attn2.to_v.weight.data.clone()
